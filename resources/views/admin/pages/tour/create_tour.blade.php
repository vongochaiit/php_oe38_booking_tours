        ...
        <div class="col-lg-12">
            <form action="{{route('admin.tour.store')}}" method="POST" enctype="multipart/form-data">
                ...
                <div class="form-group">
                    ...
                    <input type="text" class="form-control" value="{{ old('hotel_star') }}" name="hotel_star">
                ...
                <div class="form-group">
                    ...
                    <input type="text" class="form-control" value="{{ old('quantity_people') }}" name="quantity_people">
