            ...
            <div class="demo-inner-content">
                <div class="container">
                    <div class="banner-infhny">
                        <h3>@lang('language.slogan')</h3>
                        <h6 class="mb-3">@lang('language.slogans')</h6>
                            ...
                            <form action="#" method="post" class="booking-form">
                                <div class="row book-form">
                                    ...
                                    <div class="bottom-btn col-md-4 mt-md-0 mt-3">
                                        <button class="btn btn-style btn-secondary"><span class="fa fa-search mr-3" aria-hidden="true"></span> @lang('language.search')</button>
                                    </div>
                                </div>
                            </form>
                        </div>
